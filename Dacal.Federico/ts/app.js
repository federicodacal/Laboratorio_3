...
(function (PrimerParcial) {
    ...
    var Manejadora = /** @class */ (function () {
                ...
                if (xhttp.readyState == 4 && xhttp.status == 200) {
                    ...
                    if (!foto) {
                        neumaticos.forEach(function (n) {
                            ...
                            response_2 += "<tr>\n                            <td>".concat(n.id, "</td>\n                            <td>").concat(n.marca, "</td>\n                            <td>").concat(n.medidas, "</td>\n                            <td>$").concat(n.precio, "</td>\n                            <td>").concat(n.pathFoto, "</td>\n                            <td>\n                                <img src='./BACKEND/").concat(n.pathFoto, "' alt='Nope' width='50px' height='50px'></td>\n                            </td>\n                            <td> \n                                <input type='button' value='Modificar' onclick=PrimerParcial.Manejadora.ModificarNeumatico(").concat(neumatico_json, ")>\n                            </td>\n                            <td> \n                                <input type='button' value='Eliminar' onclick=PrimerParcial.Manejadora.EliminarNeumatico(").concat(neumatico_json, ")>\n                            </td>\n                            </tr>");
                        });
                    }
                    else {
                        neumaticos.forEach(function (n) {
                            var neumatico_json = JSON.stringify(n);
                            response_2 += "<tr>\n                            <td>".concat(n.id, "</td>\n                            <td>").concat(n.marca, "</td>\n                            <td>").concat(n.medidas, "</td>\n                            <td>$").concat(n.precio, "</td>\n                            <td>").concat(n.pathFoto, "</td>\n                            <td>\n                                <img src='./BACKEND/").concat(n.pathFoto, "' alt='Nope' width='50px' height='50px'></td>\n                            </td>\n                            <td> \n                                <input type='button' value='Modificar' onclick=PrimerParcial.Manejadora.ModificarNeumaticoBDFoto(").concat(neumatico_json, ")>\n                            </td>\n                            <td> \n                                <input type='button' value='Eliminar' onclick=PrimerParcial.Manejadora.BorrarNeumaticoFoto(").concat(neumatico_json, ")>\n                            </td>\n                            </tr>");
                        });
                    }
                    response_2 += "</table>";
        ...
        Manejadora.EliminarNeumatico = function (obj_json) {
        ...
        Manejadora.ModificarNeumatico = function (obj_json) {
        ...
        Manejadora.Modificar = function () {
            var id = parseInt(document.getElementById("idNeumatico").value);
            var marca = document.getElementById("marca").value;
            var medidas = document.getElementById("medidas").value;
            var precio = parseFloat(document.getElementById("precio").value);
        ...
        Manejadora.BorrarNeumaticoFoto = function (obj_json) {
            var respuesta = confirm("\u00BFConfirma eliminar a neumatico ".concat(obj_json.marca, ", medidas: ").concat(obj_json.medidas));
            if (respuesta) {
