...
<html lang="es">
    ...
    <body class="principal">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="#" onclick="Manejadora.Principal.ListadoBarbijos()">Barbijos</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#" id="btnAlta" onclick="Manejadora.Principal.ArmarFormBarbijo('agregar')">Alta Barbijo<b class="caret"></b>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="row col-sm-12">
            <div id="divBarbijo" class="cuadro col-sm-6" style= "background-color: rgb(223, 71, 71)">IZQUIERDA</div>
