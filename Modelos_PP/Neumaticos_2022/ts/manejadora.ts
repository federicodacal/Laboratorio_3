...
namespace PrimerParcial
{
    ...
    {
        public static AltaNeumaticoJSON() : void 
        {
            ...
            let precio : string = (<HTMLSelectElement>document.getElementById('precio')).value;
        ...
        public static AgregarNeumaticoSinFoto() : void 
        {
            let marca : string = (<HTMLInputElement>document.getElementById('marca')).value;
            let medidas : string = (<HTMLSelectElement>document.getElementById('medidas')).value;
            let precio : number = parseInt((<HTMLSelectElement>document.getElementById('precio')).value);
                ...
                if(!foto)
                {
                    neumaticos.forEach((n : any)=> {
                        ...
                        let neumatico_json : string = JSON.stringify(n);
                            ...
                            <td> 
                                <input type='button' value='Modificar' onclick=PrimerParcial.Manejadora.ModificarNeumaticoBD(${neumatico_json})>
                            </td>
                            <td> 
                                <input type='button' value='Eliminar' onclick=PrimerParcial.Manejadora.EliminarNeumaticoBD(${neumatico_json})>
                            </td>
                            </tr>`;
                    });
                }
                else 
                {
                    neumaticos.forEach((n : any)=> {
                        ...
                        let neumatico_json : string = JSON.stringify(n);
                            ...
                            <td> 
                                <input type='button' value='Eliminar' onclick=PrimerParcial.Manejadora.EliminarNeumaticoBDFoto(${neumatico_json})>
                            </td>
                            </tr>`;
                    });
                }
        ...
        public static ModificarNeumaticoBD(obj_json : any) : void
        {
        ...
        public static EliminarNeumaticoBD(obj_json : any) : void 
        {
        ...
        public static AgregarNeumaticoBD() : void 
        {
            let marca : string = (<HTMLInputElement>document.getElementById('marca')).value;
            let medidas : string = (<HTMLSelectElement>document.getElementById('medidas')).value;
            let precio : string = (<HTMLSelectElement>document.getElementById('precio')).value;
        ...
        public static EliminarNeumaticoBDFoto(obj_json : any) : void 
        {
            let respuesta = confirm(`¿Confirma eliminar a neumatico ${obj_json.marca}, medidas: ${obj_json.medidas}`);
