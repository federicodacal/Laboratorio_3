...
(function (PrimerParcial) {
    ...
    class Manejadora {
        ...
        static ModificarNeumaticoBD(obj_json) {
        ...
        static EliminarNeumaticoBD(obj_json) {
        ...
        static EliminarNeumaticoBDFoto(obj_json) {
            let respuesta = confirm(`¿Confirma eliminar a neumatico ${obj_json.marca}, medidas: ${obj_json.medidas}`);
            if (respuesta) {
