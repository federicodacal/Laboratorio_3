        ...
        if(isset($empleados)) //&& count($empleados) > 0)
        {
            ...
            foreach($empleados as $emp)
            {
                ...
                "<tr>
                    ...
                    <td>
                        <input type='button' value='Modificar' onclick='ModeloParcial.ModificarEmpleado($obj_json)'>
                    </td>
                    <td>
                        <input type='button' value='Eliminar' onclick='ModeloParcial.EliminarEmpleado($obj_json)'>
                    </td>
                    </tr>";
            }
            $response .= "</table>";
