        ...
        if(isset($usuarios)) //&& count($usuarios) > 0)
        {
            ...
            foreach($usuarios as $usuario)
            {
                ...
                "<tr>
                    ...
                    <td>
                        <input type='button' value='Modificar' onclick='ModeloParcial.ModificarUsuario($obj_json)'>
                    </td>
                    <td>
                        <input type='button' value='Eliminar' onclick='ModeloParcial.EliminarUsuario($obj_json)'>
                    </td>
                </tr>";
            }
            $response .= "</table>";
